...
#### Folders, tidy files and other for working files.
- `LICENSE`
- `Makefile`: Makefile with commands like `make data` or `make train`
- `README.md`: The top-level README for developers using this project.
- `docs`: fault Sphinx project; see sphinx-doc.org for details
- `references`: Data dictionaries, manuals, and all other explanatory materials.                      
- `requirements.txt`: The requirements file for reproducing the analysis environment, e.g.
                        generated with `pip freeze > requirements.txt`
- `setup.py`: Make this project pip installable with `pip install -e`
- `report`: the folder for any reports, presentations created for sharing with other people
    - `writing`: Generated analysis as HTML, PDF, LaTeX, etc.
    - `figures`: is the folder for plots, data pictures, and other images created to show data to other people. 
        - `exploratory_figures`
        - `tidy_figures`
- `notebooks`: Jupyter notebooks. Naming convention is a number (for ordering),
    ...
    - `000_diary.txt`: Link file to diary ideas and practice.
    - `001_table_experiment.txt`: Lnk file to note of approach and features and result of experiment.
    - `.py`, `.ipynb`: name 100, 200, 300... 
- `data`: is the folder for all the data collected or been given to analyze.
...
- `src`: Source code for use in this project. Raw and final in each folder.
    - `__init__.py`: Makes src a Python module
    - `config.py`: params debug, ...
    - `helpers`: command_parser
    - `logger`: folder contain logger files, log dev
    - `read_data`: Scripts to download or generate data
        - `make_dataset.py`
    - `preprocess`: clean and correct data
    - `ultis`: contain the common function 
    - `features`: Scripts to turn raw data into features for modeling
        - `name_folder`: ad-hoc features generate
        - `build_features.py`
